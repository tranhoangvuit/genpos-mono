...
export function CustomerGroupsPage() {
  ...
  const [pendingDelete, setPendingDelete] = useState<CustomerGroupRow | null>(null)
          ...
          <table className="w-full border-collapse" style={{ minWidth: 840 }}>
            ...
            <thead>
              <tr>
                ...
                <Th align="right">{t('customers.discount')}</Th>
                <Th />
              </tr>
            </thead>
            <tbody>
              ...
              {pageRows.map((r, i) => (
                <tr key={r.id} className="group transition hover:bg-[hsl(210_40%_96%_/_0.3)]">
                  ...
                  <Td>
                    <span style={{ color: r.description ? LP_FG : LP_MUTED_FG }}>
                      {r.description || '—'}
                    </span>
                  </Td>
                  <Td align="right">
      ...
      >
        <DialogContent className="max-w-md">
          ...
          <p className="text-sm" style={{ color: LP_MUTED_FG }}>
            {pendingDelete ? t('customers.confirmDeleteGroup', { name: pendingDelete.name }) : ''}
          </p>
          <DialogFooter>
            <Button
              type="button"
